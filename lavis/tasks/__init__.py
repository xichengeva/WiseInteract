...
from lavis.tasks.cpi_prediction import CPIPretrainTask, ProteinSMILESPretrainTask, ProteinSMILESEvaluation, ProteinSMILESFinetuneTask#, SMILESEGenerationEvaluation
from lavis.tasks.generation_eval import SMILESEGenerationEvaluation
...
__all__ = [
    "BaseTask",
    "CPIPretrainTask",
    "ProteinSMILESPretrainTask",
    "ProteinSMILESEvaluation",
    "SMILESEGenerationEvaluation",
    "ProteinSMILESFinetuneTask"
